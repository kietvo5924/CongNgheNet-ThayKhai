...
namespace CarRental.GlobalClasses
{
    internal static class clsGlobal
    {
        ...
        public static bool TryConnectToDatabase(out string errorMessage)
        {
            ...
            try
            {
                ...
                {
                    errorMessage = "Connection string 'ConnectionString' is missing or empty.";
                    return false;
                }
            ...
            catch (Exception ex)
            {
                ...
                clsLogError.LogError("Database Connection Exception", ex);
                return false;
            }
        }
    }
